...
#[derive(Debug, Parser)]
#[command(bin_name = "tiffany plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces tiffany-loop is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "tiffany plugin marketplace add",
    after_help = "Examples:\n  tiffany plugin marketplace add ./path/to/marketplace\n  tiffany plugin marketplace add owner/repo --ref main\n  tiffany plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "tiffany plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "tiffany plugin marketplace upgrade",
    after_help = "Examples:\n  tiffany plugin marketplace upgrade\n  tiffany plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "tiffany plugin marketplace remove",
    after_help = "Example:\n  tiffany plugin marketplace remove debug"
)]
