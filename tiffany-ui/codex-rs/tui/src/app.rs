...
pub(crate) struct App {
    ...
    tiffany_orchestrator: Option<crate::tiffany_orchestrator::TiffanyOrchestratorConfig>,
    tiffany_orchestrator_running: bool,
    tiffany_orchestrator_turns: VecDeque<crate::tiffany_orchestrator::TiffanyOrchestratorTurn>,
...
impl App {
    ...
    pub async fn run(
        ...
        tiffany_orchestrator: Option<crate::tiffany_orchestrator::TiffanyOrchestratorLaunch>,
        ...
        let tiffany_orchestrator_mode = tiffany_orchestrator.is_some();
        ...
        let wait_for_initial_session_configured =
            !tiffany_orchestrator_mode && Self::should_wait_for_initial_session(&session_selection);
        ...
        let pending_startup_thread_start = !tiffany_orchestrator_mode
            && matches!(
                &session_selection,
        ...
        let (mut chat_widget, initial_started_thread) = match session_selection {
            SessionSelection::StartFresh | SessionSelection::Exit => {
                ...
                if tiffany_orchestrator_mode {
                    chat_widget.set_tiffany_orchestrator_shell(true);
                } else {
...
See the Codex keymap documentation for supported actions and examples."
        ...
        app.chat_widget
            .set_tiffany_orchestrator_config(app.tiffany_orchestrator.clone());
