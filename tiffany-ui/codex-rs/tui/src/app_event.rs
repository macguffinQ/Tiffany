...
pub(crate) enum AppEvent {
    ...
    TiffanyOrchestratorRolesCommand {
        args: String,
    },

    /// Run a tiffany-loop orchestrator provider-management command from the TUI.
    TiffanyOrchestratorProviderCommand {
        args: String,
    },
    ...
    /// Open the current thread in desktop app.
    OpenDesktopThread {
        thread_id: ThreadId,
    },
