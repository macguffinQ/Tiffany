...
pub enum SlashCommand {
    ...
    Plan,
    Goal,
    #[strum(to_string = "provider", serialize = "providers")]
    Provider,
    Role,
    Roles,
    Thread,
...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for tiffany-loop",
            ...
            SlashCommand::App => "continue this session in desktop app",
            SlashCommand::Quit | SlashCommand::Exit => "exit tiffany-loop",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => {
                "use skills to improve how tiffany-loop performs specific tasks"
            }
            ...
            SlashCommand::Personality => "choose a communication style for tiffany-loop",
            ...
            SlashCommand::History => "inspect, search, or export native Tiffany conversation history",
            ...
            SlashCommand::Permissions => "choose what tiffany-loop is allowed to do",
            ...
            SlashCommand::Logout => "disabled; configure providers with /provider",
...
mod tests {
    ...
    #[test]
    fn roles_command_is_available_with_inline_args() {
        assert_eq!(SlashCommand::from_str("role"), Ok(SlashCommand::Role));
        assert_eq!(SlashCommand::Role.command(), "role");
    ...
    #[test]
    fn provider_command_has_plural_alias_and_inline_args() {
        assert_eq!(
            SlashCommand::from_str("provider"),
        ...
        assert!(SlashCommand::Provider.supports_inline_args());
    }
    ...
    fn certain_commands_are_available_during_task() {
        ...
        assert!(SlashCommand::Provider.supports_inline_args());
        assert!(SlashCommand::Role.available_during_task());
        assert!(SlashCommand::Role.supports_inline_args());
