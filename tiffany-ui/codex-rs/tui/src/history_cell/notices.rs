...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/macguffinQ/Tiffany".cyan().underlined(),
        ...
        let content = text![
            line![
                ...
                format!(
                    "{} -> {}",
                    crate::version::TIFFANY_LOOP_VERSION,
                    self.latest_version
                )
                .bold(),
            ],
            ...
            "https://github.com/macguffinQ/Tiffany/releases/latest"
                .cyan()
                .underlined(),
        ];
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            "See https://github.com/macguffinQ/Tiffany for installation options.".to_string()
        };
        vec![
            ...
            Line::from("https://github.com/macguffinQ/Tiffany/releases/latest"),
        ]
    }
