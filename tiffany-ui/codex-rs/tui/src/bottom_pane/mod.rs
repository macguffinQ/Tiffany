...
pub(crate) use provider_setup_view::ProviderSetupDraft;
pub(crate) use provider_setup_view::ProviderSetupView;
...
mod tests {
    ...
    fn test_pane_with_disable_paste_burst(
        ...
        BottomPane::new(BottomPaneParams {
            ...
            placeholder_text: "Ask tiffany-loop to do anything".to_string(),
            disable_paste_burst,
    ...
    fn composer_shown_after_denied_while_task_running() {
        ...
        for y in 1..area.height {
            ...
            if row.contains("Ask tiffany-loop") {
                found_composer = true;
                break;
            }
        }
