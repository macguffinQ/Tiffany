...
pub(crate) enum TerminalTitleItem {
    ...
    WeeklyLimit,
    /// tiffany-loop application version.
    CodexVersion,
...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "tiffany-loop app name",
            ...
            TerminalTitleItem::CodexVersion => "tiffany-loop application version",
