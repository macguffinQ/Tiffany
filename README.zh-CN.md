...
tar -xzf tiffany-loop-v0.1.15-aarch64-apple-darwin.tar.gz
cd tiffany-loop-v0.1.15-aarch64-apple-darwin
...
./scripts/tiffany-release-preflight --full --tag v0.1.15   # 打 tag 前
