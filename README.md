...
- `/history` - inspect/search saved Tiffany native conversation turns and synced worker events such as tool output, stderr, and diff; `/history export [--out file.md]` writes a Markdown handoff
