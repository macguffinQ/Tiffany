...
tar -xzf tiffany-loop-v0.1.22-aarch64-apple-darwin.tar.gz
cd tiffany-loop-v0.1.22-aarch64-apple-darwin
...
./scripts/tiffany-release-preflight --full --tag v0.1.22   # before tagging
./scripts/tiffany-post-release-check --tag v0.1.22          # after release/tap update
